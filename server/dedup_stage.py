...
PUSHGATEWAY = os.environ.get("DEDUP_PUSHGATEWAY_URL", "http://127.0.0.1:9091")
...
def _get_qdrant_client():
    ...
    # timeout=120: nightly window overlaps the 02:00 vzdump backup; default 5s dies on IO contention
    return QdrantClient(host=QDRANT_HOST, port=QDRANT_PORT, check_compatibility=False, timeout=120)
